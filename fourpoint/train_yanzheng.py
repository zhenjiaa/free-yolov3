...
from fourpoint.fourpoint_loss import compute_loss,compute_loss_refinenet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/ccpd/refine_down16.yaml', help='model.yaml path')
